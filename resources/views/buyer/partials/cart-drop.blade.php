@if(count(\Cart::getContent()) > 0)
    @foreach(\Cart::getContent() as $item)
        <li class="list-group-item">
            <div class="row">
                <div class="col-lg-3">
                    <img src="@if($item->logo){{asset($item->logo)}}@else{{asset('photos/agric.jpg')}}@endif"
    ...
    <div class="row" style="margin: 0px;">
        <a style="background-color:#2e6da4;" class="btn btn-dark btn-sm btn-block" href="{{ route('cart.index') }}">
