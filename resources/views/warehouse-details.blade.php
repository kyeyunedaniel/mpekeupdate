...
<!-- {{asset('photos/')}} -->
                     ...
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div style="margin-right:530px" class="carousel-caption ">
                              <h4>Welcome To <i>MpekeXchange</i></h4>
                              <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using</p>
                              <a class="btn btn-lg btn-primary" href="#" role="button"> Contract</a>
                              <a class="btn btn-lg btn-primary" href="#" role="button"> Warehouse</a>
                           </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
    ...
    <section class="content-card-style-4 pt-70 pb-100">
        <div class="container">
            ...
            <div id="Contract" class="Contract row justify-content-left">
                
                <div class="col-lg-12 col-md-7 col-sm-8">
                    <div class=" row single-content mt-15 text-center">
                        <div class=" col-4" >
                            <img style=" margin-top: 5px;margin-left: 7px" height="150px" width="150px" src="@if($Warehouse->logo){{asset($Warehouse->logo)}}@else{{asset('upload/images/lunkuse_viola_1625539581.jpg')}}@endif">
                        </div>
                        <div class="col-7">
                            <h4 class="title"><a href="javascript:void(0)">{{$Warehouse->name}} </a></h4>
                            <div class="row">
                            <div class="col-4">
                                <p>District :<i>{{$Warehouse->district}}</i></p>
                             <p> Sub-county:<i>{{$Warehouse->sub_county}}</i> </p>
                             <p>Parish:<i>{{$Warehouse->parish}}</i></p>
                            </div>
                            <div class="col-6">
                                <p>Village:<i>{{$Warehouse->village}}</i></p>
                             <p>Grain Type: <i>{{$Warehouse->grain_type}}</i></p>
                            <p>Exsistatance:<i>{{$Warehouse->existance}}</i></p>
                            </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <!-- Transporter section columnn -->
                         <div style="height:1000%" class="col-lg-6 col-md-7 col-sm-8">
...
<div class="col-12">
 <section class="doctors-col count-section">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id='about' class="about doctor-slider slider">
                                ...
                                <div style="margin-bottom:20px" class="doc-img" style="background-color: white">
                                    ...
                                    <img style="margin-left:60px" height="100px" width="100px" class="img-fluid" alt="User Image" src="{{asset('assets/img/NET logo.png')}}">
                                        <img style="margin-left:60px" height="100px" width="100px" class="img-fluid" alt="User Image" src="{{asset('assets/img/rent01.jpg')}}">
                                        <img style="margin-left:60px" height="100px" width="100px" class="img-fluid" alt="User Image" src="{{asset('assets/img/airtel.png')}}">
                                    <img style="margin-left:60px" height="100px" width="60px" class="img-fluid" alt="User Image" src="{{asset('assets/img/NET logo.png')}}">
            ...
            <div class="row" style="margin-top:50px">
               ...
               <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 paddimg-left">
                  <div class="Nursery-img">
                     <figure>
                        <img height="450px" src="../images/contactimg.jpg" alt="img"/>
                        <div class="text-box">
