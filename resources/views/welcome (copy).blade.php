                        ...
                        <nav class="main-navbar d-lg-flex justify-content-between align-items-center">
                            ...
                            <div class="navbar-search-cart d-none d-lg-flex">
                                ...
                                <div class="navbar-search search-style-5">
                                    ...
                                    <div class="search-input">
                                           <select style="width: 153px; height:35px;" class="mdb-select md-form productcategory" searchable="Search here..">
                                            <option value="" disabled selected>search by District</option>
                                            @foreach($districts as $district)
                                            <option value="{{$district->p}}">{{$district->name}}</option>
                                            @endforeach
                                            
                                            </select>
                                         <select style="width: 153px; height:35px"  class="mdb-select md-form" searchable="Search here..">
		...
		$(document).on('change','.productname',function () {
			...
			$.ajax({
				...
				success:function(data){
					...
					a.find('#receipt_id').val(data.district);
