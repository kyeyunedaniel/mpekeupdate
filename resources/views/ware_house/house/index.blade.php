...
@section('content')
    ...
    <div class="row">
            ...
            <div class="tile">
                ...
                <form action=" {{route('ware_house.store')}} " method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input placeholder="Enter Years of existance" class="form-control @error('existance') is-invalid @enderror" type="text" name="existance" id="existance" value="{{ old('existance') }}"/>
                                   ...
                                   @foreach($ware_house as $mana)
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            @if($employ->status=='1')
                                            <a href="{{ route('ware_house.edit', $employ->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit">Approved</i></a>
                                            @elseif($employ->status=='2')
                                            <a href="{{ route('ware_house.warehouse_rejected', $employ->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit">Rejected</i></a>
                                            @elseif($employ->status=='0')
                                            <a href="{{ route('ware_house.edit', $employ->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit">pending</i></a>
                                            @endif
