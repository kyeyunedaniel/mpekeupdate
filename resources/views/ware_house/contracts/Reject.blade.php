...
<body class="app sidebar-mini rtl">
    ...
    <div class="row">
        <div class="col-md-10 mx-auto">
            <div class="tile">
                <form action="{{route('ware_house_rejected_contract.store')}} " method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                    ...
                    <div class="tile-footer" style='text-align:center'>
                        <button class="btn btn-primary" name="OK" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>SUBMIT</button>
                         ...
                         <a class="btn btn-danger" href="{{ route('contracts.contracts.ware_house') }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Go Back</a>
