        ...
        <div class="col-md-12">
            <div class="tab-content">
                <div class="tab-pane active" id="general">
                    <div class="tile">
                        <!-- action="{{ route('contracts.contracts.updates') }}" method="POST" -->
                        <form  role="form">
                            @csrf
                            ...
                            <div class="tile-body ">
                                ...
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        ...
                                        <!-- <a class="btn btn-danger" href="{{route('ware_house_rejected_contract',$product->id)}}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Reject Contract</a> {{url()->previous()}} -->
                                        <a class="btn btn-danger" href="{{url('ware_house/contracts')}}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Back to previous</a>
                                    </div>
                                </div>
                            </div>
                        </form>
