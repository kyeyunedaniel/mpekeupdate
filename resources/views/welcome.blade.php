...
<select style="width: 200px" class=" form-control select2 districts" placeholder="Search by districts" id="districts" name="districts" style="width: 100%;" id="districts">
		
                                  <!-- <select style="width: 153px; height:10%" class="districts" searchable="Search here.."> -->
                                      ...
                                      @endforeach
                                         ...
                                         <select style="width: 153px; height:35px"  class="mdb-select md-form warehouse" searchable="Search here..">
                                        <option value="" disabled selected>search by Name</option>
                                        <option value="1">Techeazy</option>
                                        <option value="2">Watoto</option>
                                        <option value="3">Kanyanyo</option>
                                        <option value="3">P3P</option>
                                        <option value="3">OPok</option>
                                      </select>
                            ...
                            <div class="navbar-search-cart d-none d-lg-flex">
                                ...
                                <div class="navbar-search search-style-5">
                                    ...
                                    <div style="margin-right: 20px; " class="search-input">   
                                     ...
                                     <select  class=" form-control select2 districts" placeholder="Search by districts" id="districts" name="districts" style="width: 100%;" id="districts">
                                      <option value="" disabled selected>search by District</option>
                                      @foreach($districts as $district)
                                      <option value="{{$district->name}}">{{$district->name}}</option>
                                      @endforeach
                                    ...
                                    <div class="search-input">
                                        ...
                                        <!-- District: <input value="{{request()->input('search')}} "  id="search" name="search" type="text" placeholder="Search"> -->
                                    </div>
                                    <div style="margin-top: auto; " class="search-btn">
                ...
                <div class="container">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-7 col-sm-8">
                            ...
                            <div class="single-content mt-15 text-center">
                                <div class="content-icon">
                                <a  target="_blank" href="{{$pdt->url}} "> <img style=" margin-top: 5px;margin-left: 7px" height="100px" width="100px" src="@if($pdt->image){{asset($pdt->image)}}@else{{asset('upload/images/lunkuse_viola_1625539581.jpg')}}@endif"></a>
                                </div>
                                <div class="content-content">
                                    <h4 class="title"><a  target="_blank" href="">{{$pdt->partner_name}} ..see more</a></h4>
