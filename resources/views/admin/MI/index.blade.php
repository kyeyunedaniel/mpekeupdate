                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input min="0" placeholder="Enter Unit price" class="form-control @error('Unit') is-invalid @enderror" type="number" name="Unit" id="Unit" value="{{ old('price') }}"/>
                        ...
                        <tbody>
                            @foreach($produce as $employ)
                                ...
                                <tr>
                                    ...
                                    @foreach($farmer as $farme)
                                    @if($farme->id==$employ->user_id)
                                    <td>{{ $farme->name }}</td>
                                    @endif
                                    @endforeach
                                    <td>{{ $employ->Status }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            <a href="{{ route('admin.MI.edit',$employ->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit">Edit</i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
