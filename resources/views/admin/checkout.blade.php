                        ...
                        <div class="card">
                            ...
                            <article class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" value="{{old('address',Auth::user()->address)}} " class="form-control" name="address" required>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>City</label>
                                        <input type="text" value="{{old('city',Auth::user()->city)}} " class="form-control" name="city" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Country</label>
                                        <input type="text" value="{{old('country',Auth::user()->country)}} " class="form-control" name="country" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group  col-md-6">
                                    ...
                                    <div class="form-group  col-md-6">
                                        ...
                                        <input value="{{ old('email',auth::user()->contact) }}" type="text" class="form-control" name="phone_number"required >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required class="form-control" name="notes" rows="6"></textarea>
                                </div>
                            </article>
                        </div>
                    </div>
