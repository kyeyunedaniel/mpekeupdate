@extends('admin.app')
@section('title') Rejected warehouse Account @endsection
@section('content')
    <div class="app-title">
        <div>
            ...
            <div class="tile">
                ...
                <form  role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-footer text-center">
                         ...
                         <div class="btn-group text-center" role="group" aria-label="Second group">
                            <a href="" class="btn btn-sm btn-primary"><i class="fa fa-edit">Reject</i></a>
                        </div>
