    ...
    <div class="row">
        <div class="col-md-10 mx-auto">
            <div class="tile">
                ...
                <form action=" {{route('admin.ware_house.house.update')}} " method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                    ...
                    <div class="tile-footer">
                        <button style="margin-left: 320px;" class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Aprove</button>
                         <div class="btn-group" role="group" aria-label="Second group">
                            <a href="{{ route('admin.ware_house.house.rejected', $employee->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit">Reject</i></a>
                        </div>
