...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class=""></i> List of all warehouse managers on the system</h1>
        </div>
                            ...
                            @foreach($ware_house as $employ)
                                <tr>
                                    ...
                                    <div class="w3-col s12 w3-center">
                                         <img src="@if(asset($employ->photo)){{asset($employ->photo)}}@else{{asset('frontend/images/avatar3.png')}}@endif" width="45%" height="45%" class="" alt="">
                                     </div>
                                    </td>
                                    <td>{{ $employ->name }}</td>
                                    <td>{{ $employ->email }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            ...
                                            <a href="{{ route('admin.ware_house.edit', $employ->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit">&nbsp;Edit</i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
