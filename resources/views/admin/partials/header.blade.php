<header class="app-header" style="background-color: #2e6da4;">
    ...
    <ul class="app-nav"> 
         ...
         <li class=" dropdown">
                    <a class="app-nav__item" href="{{ route('admin.cart') }}">BUY</a>
                </li>
    ...
    <li class="dropdown">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li>
                    <a class="dropdown-item" href="{{route('change_password')}} "><i class="fa fa-key"></i>Password</a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{route('profile')}} "><i class="fa fa-user-md"></i> Profile</a>
                </li>
                <li>
