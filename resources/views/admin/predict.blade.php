                        ...
                        <div class="weather-container font-sans md:w-128 max-w-lg rounded-lg overflow-hidden bg-gray-900 shadow-lg mt-8">
                          ...
                          <div class="future-weather text-sm bg-gray-800 px-6 py-8 overflow-hidden">
                            <div>
                              ...
                              <div class="w-1/6 text-lg text-gray-200"><strong>{{ $f->day }}</strong> </div>
                              <div class="w-4/6 px-4 flex items-center">
                                <div><img height="24" width="24" src="{{$f->image}} "></div>
                                <div class="ml-3">{{$f->phrase }}</div>
                              </div>
                              <div class="w-1/6 text-center">
                                <div><i>Low temperature:</i> {{ convert2cen($f->low,$f->low_unit) }}°C</div>
                                <div> <i> High temperature: </i>{{ convert2cen($f->high,$f->high_unit) }}°C</div>
                              </div>
                              @endforeach
                            </div>
    ...
    <footer class="py-4 bg-light mt-auto">
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between small">
                ...
                <div ><a target="_blank" href="">powered by MpekeXchange</a></div>
            </div>
        </div>
    </footer>
</div>
