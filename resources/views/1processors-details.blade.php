                            ...
                            <div class="navbar-search-cart d-none d-lg-flex">
                                ...
                                <div class="navbar-search search-style-5">
                                     <div style="margin-right:-15px" class="row ">
                                          <select style="max-width:155px;margin-right:50px" class=" form-control select2 productcategory" id="prod_cat_id">		
                                                  <option value="0" disabled="true" selected="true">search by district</option>
                                                  @foreach($districts as $cat)
                                                    <option value="{{$cat->name}}">{{$cat->name}}</option>
                                                  @endforeach
                                          ...
                                          <select name="search" id="productname" style="max-width:155px;" class="form-control select2 productname" >		
                                                  <option value="0" disabled="true" selected="true">search by name</option>
                                                    @foreach($ware_hous as $cat)
                                                    <option value="{{$cat->name}}">{{$cat->name}}</option>
                                                  @endforeach
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box ">
                              <figure><img height='300px' src="{{asset('photos/maize-998x570.jpg')}}" alt="img"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12">
                    <div style="margin-right:'120px" class="">
                        <h4>ABOUT US</h4>
                        <p>
                            Epicle is a ICT Company that deals in software developments and automation of business
                        ...
                        <p>
                            Epicle is a privately owned company Located at Plot 2183 Esseri Building Kayondo Road
