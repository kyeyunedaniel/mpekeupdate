 ...
 <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card card-body">                        
                        <form class="form-layout form-layout-1" action="{{route('warehouse.profile')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group my-3">
                                <label class="form-control-label">NIN Number: <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="NIN" value="{{Auth::user()->NIN}}" placeholder="{{__('NIN')}}" required>
                                @error('name')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-2 col-md-6">
                                <label class="form-control-label">Upload driving license:</label>                                
                                <label class="custom-file wd-100p">
                                    <input type="file" name="driving_license" id="driving_license" class="file-input-styled" accept="image/*">
                                </label>
                            </div>
                            </div>                            
