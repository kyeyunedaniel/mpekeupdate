...
<aside class="app-sidebar" >
 ...
 <div class="w3-col s12 w3-bar w3-center">
  ...
  <span class="app-menu__label" style="color: white;">Trasporter</span>
  </div>
</div>

<ul class="app-menu">
    <li>
        <a class="app-menu__item {{ Route::currentRouteName() == 'processor.processor' ? 'active' : '' }}" href="{{route('transportor.index')}} ">
    ...
    <li>
        <a class="app-menu__item {{ Route::currentRouteName() == 'processor_forecast' ? 'active' : '' }}" href="{{route('Trasporter_forecast')}} ">
            <i class="app-menu__icon fa fa-shopping-bag"></i>
            <span class="app-menu__label">&nbsp;&nbsp;Forecast</span>
        </a>
    </li>
    <li>
        <a class="app-menu__item {{ Route::currentRouteName() == 'Trasporter.create' ? 'active' : '' }}" href=" {{route('Trasporter.create')}} ">
