  ...
  background-color: #fff;
   ...
   <link href="{{asset('css/bootstrap-multiselect.css')}}" rel="stylesheet" type="text/css">
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.13/css/bootstrap-multiselect.css" />
       ...
       <link href="{{asset('css/signture.css')}}" rel="stylesheet" type="text/css"> 
  <script type="text/javascript" src="{{asset('js/signture.js')}}"></script>
                        ...
                        <div class="tile">
                            ...
                            <form action="{{route('contracts.contracts.store')}}" aria-label="{{ __('Upload') }}" enctype="multipart/form-data" method="POST" role="form">
                                ...
                                <div style="margin-left: 80px;" class="tile-body">
                                    ...
                                    <div class="row">
                                    <!-- <div class=" col-md-6 form-group">
                                        <label class="control-label" for="name">Grain Name</label>
                                        <input
                                       ...
                                       <div class=" col-md-6 form-group">
                                        <label class="control-label" for="name">Expected Quantity (Kgs)</label>
                                        <input
                                            class="form-control @error('name') is-invalid @enderror"
                                            type="number"
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required name="maize_status" id="framework" class="form-control @error('maize_status') is-invalid @enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required name="categories_id" id="categories_id" class="form-control @error('categories_id') is-invalid @enderror">
...
<!--                                         
                             ...
                             <div class="col-lg-6 col-md-7 col-sm-12">
                                ...
                                <p  >Update your profile first <strong><a href="{{route('profile_Farmer')}} "> Profile</a></strong> </p>
                                 </div>
                                </div>
                            @endif
