        ...
        <div class="col-md-12">
            <div class="tab-content">
                <div class="tab-pane active" id="general">
                    <div class="tile">
                        <form action="{{ route('contracts.contracts.update') }}" method="POST" role="form">
                            @csrf
                            ...
                            <div class="tile-body ">
                                  ...
                                  <div class="row">
                                    ...
                                    <label class="control-label" for="name">Land Size</label>
                                    <input
                                        class="form-control @error('LandSize') is-invalid @enderror"
                                        type="text"
                                        placeholder="Enter attribute LandSize"
                                        id="LandSize"
                                        name="name"
                                        value="{{ old('LandSize', $product->Land_size) }}"
                                    />
                                        @error('LandSize') <span>{{ $message }}</span> @enderror
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label" for="date_available">Maize Status</label>
                                    <input
                                        class="form-control @error('date_available') is-invalid @enderror"
                                        type="text"
                                        placeholder="Enter maize date_available"
                                        id="date_available"
                                        name="date_available"
                                        value="{{ old('date_available', $product->maize_status) }}" readonly
                                    />
                                    <div class="invalid-feedback active">
                                        <i class="fa fa-exclamation-circle fa-fw"></i> @error('date_available') <span>{{ $message }}</span> @enderror
                                    </div>
