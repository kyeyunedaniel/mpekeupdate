                            ...
                            <div class="navbar-search-cart d-none d-lg-flex">
                                ...
                                <div class="navbar-search search-style-5">
                                    <div style="margin-right:40px" class="search-input">
                                          <select style="width: 100%;" class="form-group form-control select2 productcategory" id="prod_cat_id">		
                                    ...
                                    <div class="search-input">
                                        <input value="{{request()->input('search')}} " required id="search" name="search" type="text" placeholder="Search">
                                    </div>
                                    <div class="search-btn">
                                        <button class="submit"><i class="lni lni-search-alt"></i></button>
                                    </div> -->
...
<!-- 
    <section class="header-style-1">
        <div class=" row header-big">
            <div  class="header-items-active">
                ...
                <div class="single-header-item bg_cover"
                    style="background-image: url('{{asset('photos/maize-998x570.jpg')}}');height: 350px;">
                    <div class="header-item-content">
                        <h3 class="title">Welcome to MpekeXchange </h3>
                        <a href="javascript:void(0)" class="link">Grain quality matters</a>
                    </div>
                ...
                <div class="single-header-item bg_cover"
                    style=" background-image: url('{{asset('photos/mpererwe.jpg')}}');height: 350px;">
                    <div class="header-item-content">
                        <h3 class="title">Welcome to MpekeXchange </h3>                        
                        <a href="javascript:void(0)" class="link">Grain quality matters</a>
                    </div>
            ...
            <div class="carousel-inner">
                  ...
                  <div class="container">
                     <div class="row marginii">
                        <div  class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div style="margin-right:530px" class="carousel-caption justify-content-left">
                              <h5>Welcome To <i>MpekeXchange</i></h4>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div style="margin-right:530px" class="carousel-caption ">
                              <h5>Welcome To <i>MpekeXchange</i></h5>
                              <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using</p>
                              <a class="btn btn-lg btn-primary" href="#contract" role="button"> Contract</a>
                              <a class="btn btn-lg btn-primary" href="#" role="button"> Warehouse</a>
                           </div>
                  ...
                  <div class="container">
                     <div  class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md- col-sm-12">
                           <div  style="margin-right:530px" class="carousel-caption ">
                              <h5 style="color:white">Welcome To <i>MpekeXchange</i></h5>
                              <p style="color:darkgreen">Grain quality matters</p>
                              <p style="color:white">A user(buyer, farmer and warehouse manager) creates an account by filling in the required fields as shown in the figure below,<br/> Clicks submit button to continue and data captured is saved.</p>
                              <a class="btn btn-lg btn-primary" href="#contract" role="button"> Contract</a>
                              <a class="btn btn-lg btn-primary" href="#" role="button"> Warehouse</a>
                           </div>
                        </div>
                        ...
                        <!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img height='300px' src="{{asset('photos/Maize-plants-1.jpeg')}}" alt="img"/></figure>
                           </div>
                        </div> -->
                     </div>
                  </div>
    ...
    <section class="content-card-style-4 pt-70 pb-100">
        <div class="container">
            <h4>More processor details</h4>
            <div class="row justify-content-left">
                
                <div class="col-lg-12 col-md-7 col-sm-8">
                    <div class=" row single-content mt-15 text-center">
                        <div class=" col-4" >
                           
                                @foreach($users as $user)
                               @if($Warehouse->user_id==$user->id)
                                <img style=" margin-top: 5px;margin-left: 7px" height="150px" width="150px" src="@if($user->photo){{asset($user->photo)}}@else{{asset('upload/images/lunkuse_viola_1625539581.jpg')}}@endif">
                                <p>Owner:<i>{{$user->name}}</i></p>

                               @endif
                              @endforeach 
                        </div>
                        <div class="col-7">
                            <h4 class="title"><a href="javascript:void(0)">{{$Warehouse->name}} </a></h4>
                            <div class="row">
                            <div class="col-4">
                                 <img style=" margin-top: 5px;margin-left: 7px" height="150px" width="150px" src="@if($Warehouse->image){{asset($Warehouse->image)}}@else{{asset('upload/images/lunkuse_viola_1625539581.jpg')}}@endif">
                            </div>
                            <div class="col-6">
                                
                            <p>Location :<i>{{$Warehouse->Location}}</i></p>
                             <p> Description:<i>{{$Warehouse->description}}</i> </p>
                             <p>category:<i>{{$Warehouse->category}}</i></p>
                            </div>
                            </div>
    ...
    <!--====== Warehouse Content Card  Part Start ======-->
                <section id="contract" class="contract content-card-style-4 pt-70 pb-100">
                    <div class="container">
                                        ...
                                        @foreach( $ware_hous as $photo )
                                                ...
                                                <div style='margin-left:45px'  class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                                    <a href="{{route('warehouse-list',$photo->id)}}">
                                                        <img  class="d-block" height="200" src="{{ asset($photo->logo) }}" alt="{{ $photo->name }}" width="350"  >
                                                    </a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="doctor-slider slider">
                                ...
                                <div style="margin-bottom:20px" class="doc-img" style="background-color: white">
        ...
        <div class="col-lg-4" >
            ...
            <section class="content-card-style-4 pt-70 pb-100">
                <div class="container">
                    <h5 style="margin-left:150px;margin-bottom:35px" >Adverts</h5>
                    <div class="row justify-content-center">
                        <!-- Transporter section columnn -->
                         <div class="col-lg-6 col-md-7 col-sm-8">
                            <h5 style="margin-left:20px" >Transporter</h5>
                        ...
                        <!-- Processors column section -->
                        <div class="col-lg-6 col-md-7 col-sm-8">
                            <h5 style="margin-left:45px" >Processors</h5>
...
<div class="row">
 <section id="about" class="about doctors-col count-section">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="doctors-title ">
...
<div  class="">
            ...
            <div class="row" style="margin-top:1px">
                     ...
                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <form>
                           <div class="row">
                              ...
                              <div style="margin-top:10px;margin-left:250px" class="col-xl-4 col-lg-4 col-md-4 col-sm-4 justify-content-right">
                                 <button width="50px" type="submit" class="btn btn-primary btn-block">Submit</button>
                              </div>
                           </div>
                        </form>
                     </div>
               ...
               <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 paddimg-left">
                  <div class="Nursery-img">
                     <figure>
                        <img height="520px" src="../images/Maize-plants-1.jpeg" alt="img"/>
                        <div class="text-box">
    ...
    <script src="{{asset('assets2/js/jquery-vj-accordion-steps.js')}}"></script>

    <!--====== Jquery Ui js ======-->
    <script src="{{asset('assets2/js/jquery-ui.min.js')}}"></script>

    <!--====== Form validator js ======-->
    <script src="{{asset('assets2/js/jquery.form-validator.min.js')}}"></script>

    <!--====== nice select js ======-->
    <script src="{{asset('assets2/js/jquery.nice-select.min.js')}}"></script>

    <!--====== formatter js ======-->
    <script src="{{asset('assets2/js/jquery.formatter.min.js')}}"></script>

    <!--====== Main js ======-->
    <script src="{{asset('assets2/js/count-up.min.js')}}"></script>

    <!--====== Main js ======-->
    <script src="{{asset('assets2/js/main.js')}}">
