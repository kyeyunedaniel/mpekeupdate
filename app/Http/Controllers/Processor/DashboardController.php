    ...
    public function __construct()
    {
        ...
        return view('processor.profile', compact('user'));
         ...
         public function forecast(){
            ...
            return view('processor.Forecast',compact('forecast','current'));//,['forecast'=>$forecast]
        }
        public function predict(){
            ...
            return view('processor.predict',compact('api_result','location'));
        }
     ...
     public function profile_pass(Request $request){
        ...
        return view('processor.change_password', compact('user'));
    }
      ...
      public function change_user(Request $request){
        ...
        if (Hash::check($request->old_password,auth()->user()->password)) {
           $user= auth()->user()->password = Hash::make($request->get('password'));
           $user->update();
        return redirect()->route('login')->with("success",'password updated successfully');
            // dd('password match');
        }else{
            return redirect()->route('processor.profile')->with("error",'password does not match');
        }
    }
